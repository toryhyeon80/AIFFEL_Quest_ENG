...
- [ ] **2. 핵심 코드에 주석 또는 docstring이 있어 이해가 되었나요?**
- [ ] **3. 에러 디버깅 또는 추가 실험 기록이 있나요?**
- [ ] **4. 회고를 잘 작성했나요?**
- [ ] **5. 코드가 간결하고 효율적인가요?**
...
```
# 로컬 macOS에서 `python` 명령이 없어 venv 생성이 실패했고, python3로 해결했다.
# Oracle Cloud Always Free는 Osaka AD-1 용량 부족으로 인스턴스 생성이 막혔다.
# OmniRoute는 Cursor에서 localhost가 막혀 ngrok HTTPS로 연결했다.
```
